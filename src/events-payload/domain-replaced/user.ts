...
export class UserProps {  
  ...
  employmentStatus?: UserEmploymentStatusProps = new UserEmploymentStatusProps();
  employerName?: UserEmployerNameProps = new UserEmployerNameProps();
  employerPosition?: UserEmployerPositionProps = new UserEmployerPositionProps();
  investmentExperience?: UserInvestmentExperienceProps = new UserInvestmentExperienceProps();
  investmentObjective?: UserInvestmentObjectiveProps = new UserInvestmentObjectiveProps();
  ...
  userBrokerApplicationData?: UserBrokerApplicationDataProps = new UserBrokerApplicationDataProps();
