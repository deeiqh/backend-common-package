...
export async function dtoFactory(): Promise<void> {
  ...
  await fs.writeFile(
    `/home/deeiqh/Documents/hapi/@hapi-corp/hapi-corp-backend-common-package/src/events-payload/dtos/user-props.dto.ts`,
    content,
  );
